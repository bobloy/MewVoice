...
[**mewvoice.com**](https://mewvoice.com) &nbsp;|&nbsp; [GitHub Releases](https://github.com/bobloy/MewVoice/releases) &nbsp;|&nbsp; [NexusMods](https://www.nexusmods.com/mewgenics)
...
- **Desktop app** — install and manage voice packs locally, compatible with the [Mewtator](https://www.nexusmods.com/mewgenics/mods/1) mod loader
...
2. Install the [MewVoice Desktop app](https://github.com/bobloy/MewVoice/releases/latest) — also available on [NexusMods](https://www.nexusmods.com/mewgenics)
3. Install [Mewtator](https://www.nexusmods.com/mewgenics/mods/1) if you haven't already
...
The desktop app is released via [GitHub Releases](https://github.com/bobloy/MewVoice/releases) and [NexusMods](https://www.nexusmods.com/mewgenics). The web app and API are deployed to Cloudflare.
